...
echo "<li title='$vs'  class='w-newfigure w-newfigure-180x287'><a class='js-link' href='./play.php?play=$hjiami' title='$vs' target='_blank'><div class='w-newfigure-imglink g-playicon js-playicon'><img src='$likeimg[$ks]' alt='$vs'/></div><div class='w-newfigure-detail'><p class='title g-clear'><span class='s1'>$vs</span></p></div></a></li>  "; } ?>
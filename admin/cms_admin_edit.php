						...
						<div class="col-lg-12">
							<div class="panel bk-bg-white">
								...
								<div class="panel-body">
									...
									<?php
					$result = mysqli_query($conn,'select * from mkcms_manager where m_id = '.$_GET['id'].'');
												...
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group has-feedback">
															<label for="name-w1">登录账号</label>
															<input id="a_name" class="form-control" name="a_name" type="text" size="60" data-validate="required:请填写登录账号" value="<?php echo $row['m_name'];?>" />
														</div>
													</div>
												</div>
												<div class="row">

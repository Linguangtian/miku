												...
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group has-feedback">
															...
															<input id="a_name" class="form-control" name="a_name" type="text" size="60" data-validate="required:请填写登录账号" value="" />
														</div>
													</div>
												</div>
<div class="row">
								...
								<div class="panel-body">
									<div class="table-responsive">	
										<table class="table table-striped table-bordered bootstrap-datatable datatable">
											...
											<tbody>								
												<?php
							$result = mysqli_query($conn,'select * from mkcms_manager');

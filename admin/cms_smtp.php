						...
						<div class="col-lg-12">
							<div class="panel bk-bg-white">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-tags red"></i>邮件配置</h6>
								</div>
...
<div class="row">
													<div class="col-md-12">
													<label for="name-w1">SMTP账号</label>
<div class="form-group has-feedback">
<input id="s_muser" class="form-control" name="s_muser" type="text" size="60" data-validate="required:SMTP账号" value="<?php echo $row['s_muser']?>" />

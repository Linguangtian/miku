...
<div class="container">
	<div class="row">
		<div class="col-lg-wide-75 col-xs-1 padding-0">
                                    ...
                                    <div class=" col-md-4">
                                        <div class="input-group">
                                            <select style="color:blue;" name="mode" id="mode" class="form-control">
												...
												<option value="cxqx.php?wd=">全网搜①号线（18个站）&nbsp;&nbsp;▼</option>
												...
												<option value="seacherdb.php?wd=">豆瓣资源站&nbsp;&nbsp;▼</option>
												<option value="seachergq.php?wd=">最新资源站&nbsp;&nbsp;▼</option>
                                            </select>
			...
			<div class="stui-pannel__head active bottom-line clearfix">
				<span class="more text-muted pull-right hidden-xs"></span>
					<h3 class="title"><svg class="iconm" aria-hidden="true"><use xlink:href="#icon-list"></use></svg><span style="color: #FF00FF;">最新资源：</span>搜索到与《<a href="/seacher-<?php echo $q?>.html" title="<?php echo $q?>"><?php echo $q?></a>》相关的影片
					</h3>
			</div>
		</div>
		<div class="stui-pannel_hd">
...
$cxianshi='style="display:none"';
						...
						if ($row['d_jifen']>0){
							...
							<div class="thumb">
							<a class="v-thumb stui-vodlist__thumb lazyload" <?php echo $ok;?> href="<?php echo $ccb.$html;?>" title="<?php echo $data["data"][$i]["vod_name"]; ?>" data-original="<?php echo $data["data"][$i]["vod_pic"]; ?>"><span class="play hidden-xs"></span>
							...
							<div class="detail">
							<h3 class="title"><a href="<?php echo $ccb.$html;?>"><?php echo $data["data"][$i]["vod_name"]; ?><span class="playtype"><?php echo $data["data"][$i]["list_name"];?>·<?php echo $data["data"][$i]["d_year"];?></span></a></h3>
						...
						<?php }} ?>
						<?php $cxsearch=$data["data"][0]["vod_name"]; if (empty($cxsearch)||$data['data'][$i]['vod_cid']>=18 ){?> <p style="text-align: center;"><img class="sosoimg" src="/template/jingpin/img/blank.png" alt="暂无内容"/></p><?php }?>
						</ul>
					</div>
						</div>				</div>
				</div>

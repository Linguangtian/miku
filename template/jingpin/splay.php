...
$mjk=$mkcms_mjk;
$seach = 'http:'.$player;
$rurl = fileget2($seach,10);
$vname ="#<meta name=\"title\" content=\"(.*?)\" />#";
$vimg ='#<meta itemprop="image" content="(.*?)"/>#';
$nname ="#<meta itemprop=\"url\" content=\"(.*?)\"/>#";
preg_match_all($vimg, $rurl,$imgarr); 
preg_match_all($lname, $rurl, $xarr0);
preg_match_all($nname, $rurl, $xarr);
preg_match_all($vname, $rurl, $xarr1);
$xbflist = $xarr[1][0];
$ximg = $imgarr[1][0];
$yname = $xarr1[1][1];
?>
<title><?php echo $yname;echo "-搞笑视频-";echo $mkcms_seoname;?></title>
<meta name="keywords" content="<?php echo $yname;?>,<?php echo $mkcms_keywords;?>">
<meta name="description" content="<?php echo $yname;?>,<?php echo $mkcms_description;?>">
<style type="text/css">
...
<li class='zyli'><a href='<?php echo $xbflist;?>' class='btn btn-danger btn-play-source 1' title='<?php echo $yname;?>'><img src='<?php echo $ximg;?>' onerror=src='/template/jingpin/img/load.gif' alt='<?php echo $yname;?>' width='100%'><br><?php echo $yname;?></a></li>
</ul>
</div>
	</div>
</div>

...
<div class="container">
	<div class="row">
		<div class="col-lg-wide-75 col-xs-1 padding-0">
                                    ...
                                    <div class=" col-md-4">
                                        <div class="input-group">
                                            <select style="color:blue;" name="mode" id="mode" class="form-control">
												...
												<option value="cxqx.php1?wd=">全网搜②号线（高速线路）&nbsp;&nbsp;▼</option>
			...
			<div class="stui-pannel__head active bottom-line clearfix">
				<span class="more text-muted pull-right hidden-xs"></span>
					<h3 class="title"><svg class="iconm" aria-hidden="true"><use xlink:href="#icon-list"></use></svg><span style="color: #FF00FF;">卧龙资源：</span>搜索到与《<a href="/seacher-<?php echo $q?>.html" title="<?php echo $q?>"><?php echo $q?></a>》相关的影片
					</h3>
			</div>
		</div>
		<div class="stui-pannel_hd">
...
$cxianshi='style="display:none"';
						...
						if ($row['d_jifen']>0){
							...
							<div class="detail">
							<h3 class="title"><a href="<?php echo $ccb.$html;?>"><?php echo $cmname[0]; ?><span class="playtype"><?php echo $data["data"][$i]["list_name"];?>·<?php echo $data["data"][$i]["d_year"];?></span></a></h3>

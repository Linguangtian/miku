...
function page_show($_var_15, $_var_16, $_var_17, $_var_18)
{
	...
	for ($_var_36 = $_var_23; $_var_36 <= $_var_24; $_var_36++) {
		if ($_var_36 == $_var_20) {
			$_var_32 = $_var_32 . '<a target="_self" class="page_current">' . $_var_36 . '</a>';
		} else {
...
function page_shows($_var_37, $_var_38, $_var_39, $_var_40)
{
	...
	if ($_var_42 == 1) {
		...
		$_var_47 = '<a href="' . $_var_43 . ($_var_42 - 1) . '.html" title="上一页"><<</a>';
	}
	for ($_var_53 = $_var_45; $_var_53 <= $_var_46; $_var_53++) {
		if ($_var_53 == $_var_42) {
			$_var_49 = $_var_49 . '<a href="javascript:void(0)" class="page_current">' . $_var_53 . '</a>';
		} else {
			$_var_49 = $_var_49 . '<a href="' . $_var_43 . $_var_53 . '.html" title="第' . $_var_53 . '页">' . $_var_53 . '</a>';
		}
	}
	if ($_var_42 < $_var_41 - $_var_44) {
		$_var_50 = '<a href="' . $_var_43 . $_var_41 . '.html" title="尾页">...' . $_var_41 . '</a>';
	}
	if ($_var_42 == $_var_41) {
		$_var_51 = '';
	} else {
		$_var_51 = '<a href="' . $_var_43 . ($_var_42 + 1) . '.html" title="下一页">>></a>';
	}
...
function page_show1($_var_84, $_var_85, $_var_86, $_var_87)
{
	$_var_88 = $_var_84;
	$_var_89 = $_var_85;
	$_var_90 = $_var_86;
	...
	$_var_92 = '';
	$_var_93 = '';
	$_var_92 = $_var_89 - $_var_91;
	if ($_var_92 <= 0) {
		$_var_92 = 1;
		$_var_93 = $_var_92 + $_var_93;
	}
	$_var_93 = $_var_89 + $_var_91;
	if ($_var_93 > $_var_88) {
		$_var_93 = $_var_88;
	}
	$_var_94 = $_SERVER['REQUEST_URI'];
	$_var_95 = parse_url($_var_94);
	if (isset($_var_95['query'])) {
		$_var_96 = $_var_95['path'];
		$_var_97 = $_var_95['query'];
		parse_str($_var_97, $_var_98);
		unset($_var_98[$_var_90]);
		if (count($_var_98) != 0) {
			$_var_94 = $_var_96 . '?' . http_build_query($_var_98) . '&';
		} else {
			$_var_94 = $_var_96 . '?';
		}
	} else {
	...
	$_var_103 = '';
	$_var_104 = '';
	if ($_var_89 > $_var_91 + 1) {
		$_var_100 = '<a href="' . $_var_94 . $_var_90 . '=1" title="首页">1..</a></li>';
	}
	if ($_var_89 == 1) {
		$_var_99 = '';
	} else {
		$_var_99 = '<li><a href="' . $_var_94 . $_var_90 . '=' . ($_var_89 - 1) . '" title="上一页"><<</a></li>';
	}
	for ($_var_105 = $_var_92; $_var_105 <= $_var_93; $_var_105++) {
		if ($_var_105 == $_var_89) {
			$_var_101 = $_var_101 . '<li class="active"><a target="_self" >' . $_var_105 . '</a></li>';
		} else {
			$_var_101 = $_var_101 . '<li><a href="' . $_var_94 . $_var_90 . '=' . $_var_105 . '" title="第' . $_var_105 . '页">' . $_var_105 . '</a>';
		}
	}
	if ($_var_89 < $_var_88 - $_var_91) {
		$_var_102 = '<li><a href="' . $_var_94 . $_var_90 . '=' . $_var_88 . '" title="尾页">..' . $_var_88 . '</a></li>';
	}
	if ($_var_89 == $_var_88) {
		$_var_103 = '';
	} else {
		$_var_103 = '<li><a href="' . $_var_94 . $_var_90 . '=' . ($_var_89 + 1) . '" title="下一页">>></a></li>';
	}
	$_var_104 = $_var_104 . $_var_99 . $_var_100 . $_var_101 . $_var_102 . $_var_103 . '';
	return $_var_104;
}